...
Wie wohl jeder von uns habe ich irgendwann in meinem Leben angefangen Daten anzuhäufen und wollte diese irgendwann endlich digitalisieren und ordnen. Also wird irgendein Storage System mit Festplatten benötigt und eine Methode (Full oder Delta) Backups zu erstellen.

Begonnen habe ich diese Odyssee mit diversen Raspberry PIs. Letzlich waren es so viele Dinge die ich mit PIs ausprobiert habe, dass es sich irgendwann gelohnt hat die link:https://huluvu424242.github.io/Raspi-Garage/[Raspi Garage] in Leben zu rufen.
